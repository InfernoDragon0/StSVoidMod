...
public class Devouring extends CustomCard {
    public static final String ID = "Devouring";
    public static final String NAME = "Devouring";
    public static final String DESCRIPTION = "Devour 5, Ethereal, Exhaust.";
