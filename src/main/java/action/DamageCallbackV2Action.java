...
public class DamageCallbackV2Action extends AbstractGameAction {
    private DamageInfo info;
    Consumer<AbstractCreature> callback;

    public DamageCallbackV2Action(AbstractCreature target, DamageInfo info, AttackEffect effect, Consumer<AbstractCreature> callback) {
        this.info = info;
